...
let handler = async (m, { conn }) => {
  try {
    ...
    // Obtener uso del CPU y detalles del sistema
...
async function testInternetSpeed() {
  try {
    ...
    return {
      downloadSpeed: (result.download.bandwidth / 125000).toFixed(2), // Convertir a Mbps
      uploadSpeed: (result.upload.bandwidth / 125000).toFixed(2), // Convertir a Mbps
    };
  } catch (error) {
