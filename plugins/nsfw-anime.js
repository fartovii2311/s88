...
let handler = async (m, { conn, command, usedPrefix }) => {
    ...
    const randomVideo = randomList[Math.floor(Math.random() * randomList.length)];

    await conn.sendMessage(m.chat, { video: { url: randomVideo }, caption: 'Aquí tienes un video aleatorio' }, { quoted: m });
};

handler.help = ['randomvid'];
handler.tags = ['nsfw'];
