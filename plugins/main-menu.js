...
➫ _\`𝙰𝚌𝚝𝚒𝚟𝚘𝚜\`_ :: _%muptime_
➫ _\`𝚄𝚜𝚞𝚊𝚛𝚒𝚘\`_ :: _%rtotalreg de %totalreg_
➫ _\`𝙲𝚘𝚛𝚊𝚣𝚘𝚗𝚎𝚜\`_ :: _%corazones_
➫ _\`𝙿𝚛𝚎𝚏𝚒𝚡𝚘\`_ :: _< . >_
➫ _\`𝙲𝚛𝚎𝚊𝚍𝚘𝚛\`_ :: _𝙳𝚊𝚛𝚔𝙲𝚘𝚛𝚎_
...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command }) => {
  ...
  try {
    ...
    let after = conn.menu.after || (conn.user.jid == global.conn.user.jid ? '' : `https://wa.me/${global.conn.user.jid.split`@`[0]}`) + defaultMenu.after
    let _text = [
      before,
