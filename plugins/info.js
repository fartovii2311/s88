...
git clone https://github.com/GataNina-Li/ДемонLite-MD 
cd ДемонLite-MD
yarn install
npm install
npm start`
...
let replit = `*◎ R E P L I T*\n\nhttps://replit.com/github/GataNina-Li/ДемонLite-MD`
let heroku = `*◎ H E R O K U*\n\nhttps://heroku.com/deploy?template=https://github.com/GataNina-Li/ДемонMDLite-Heroku`
...
description = official[0][0] == String(contact[0]) ? 'Solo temas de Демон' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'centerДемон@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
