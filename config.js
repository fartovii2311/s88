...
global.fakegif2 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "0@g.us" } : {}) }, message: { videoMessage: { title: '', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘✨', jpegThumbnail: catalogo }}};
...
global.fakegif4 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "0@g.us" } : {}) }, message: { videoMessage: { title: '', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '(^_^♪) 💥', jpegThumbnail: catalogo }}};
